...
def tiny_vit_5m_224(pretrained=False, drop_path_rate=0.0):
    return TinyViT(
...
@register_tiny_vit_model
def tiny_vit_11m_224(pretrained=False, drop_path_rate=0.1):
    return TinyViT(
...
@register_tiny_vit_model
def tiny_vit_21m_224(pretrained=False, drop_path_rate=0.2):
    return TinyViT(
...
@register_tiny_vit_model
def tiny_vit_21m_384(pretrained=False, drop_path_rate=0.1):
    return TinyViT(
        img_size=384,
        embed_dims=[96, 192, 384, 576],
        depths=[2, 2, 6, 2],
...
@register_tiny_vit_model
def tiny_vit_21m_512(pretrained=False, drop_path_rate=0.1):
    return TinyViT(
        img_size=512,
        embed_dims=[96, 192, 384, 576],
        depths=[2, 2, 6, 2],
